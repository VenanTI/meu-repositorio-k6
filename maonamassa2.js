...
export default function () {
    const crocodilo = data[Math.floor(Math.random() * data.length)].id //cria uma constante que recebe um valor aleatório do json e multiplica pelo length e o .id é o que você quer achar
